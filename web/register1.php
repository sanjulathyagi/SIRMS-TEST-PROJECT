                ...
                <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if (empty($message)) {
                            ...
                            $msg .= "<a href='http://localhost/bittest/verify.php?token=12346789'>Click here to verifiy your account</a>";
...
if($_SERVER['REQUEST_METHOD']=='GET'){
    ...
    if($result){                
        echo "Your account has been verified!. You can now access the dashbord.";
...
class User {
    ...
    public function save($FirstName, $LastName, $UserName, $pw, $UserType) {
        $sql = "INSERT INTO users(FirstName,LastName,UserName,Password,UserType,Status) VALUES ('$FirstName','$LastName','$UserName','$pw','$UserType','1')";
        $this->db->query($sql);
