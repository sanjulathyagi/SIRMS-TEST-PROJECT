      ...
      <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" role="form" class="php-email-form"
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 col-md-">
            ...
            <input type="text" class="form-control border border-1 border-dark" name="user_name" id="user_name"
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 col-md-6">
            ...
            <input type="password" class="form-control border border-1 border-dark" name="password" id="password"
        ...
        <div class="row justify-content-center">
          <button type="submit" style="border:solid; width:30%; height:30%; align:center" class="btn btn-dark"
