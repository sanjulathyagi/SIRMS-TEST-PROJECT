...
<html lang="en">
    ...
    <body class="hold-transition login-page" style="background-color: #000012">
        <div class="login-box">
            <div class="login-logo">
                <img src="assets/dist/img/logo.png" class="img-fluid" width="100" alt=""/><br>
                <a href="../../index2.html" class="text-white"><b>SuperZonic</b></a>
            </div>
            <!-- /.login-logo -->
            <?php
            ...
            ?>
            <div class="card" style="border: solid 2px #000  ">
